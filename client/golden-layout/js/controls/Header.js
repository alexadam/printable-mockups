...
lm.controls.Header = function( layoutManager, parent ) {
	...
	// console.log('Parent', parent.contentItems[0].config);
...
//////
	...
	this._dragListener = new lm.utils.DragListener( this.dragMeElem );
	...
	var closeStack = lm.utils.fnBind( this.parent.remove, this.parent );
...
// 	'<div class="lm_header">',
// 	'<ul class="lm_tabs"></ul>',
// 	'<ul class="lm_controls"><button class="aaa-drag">aaa</button></ul>',
